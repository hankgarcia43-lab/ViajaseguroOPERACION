...
# Opcionales por rol. Si no existen, se usan las dos variables globales anteriores.
MERCADOPAGO_PASSENGER_SUBSCRIPTION_AMOUNT=150
MERCADOPAGO_PASSENGER_SUBSCRIPTION_DAYS=30
MERCADOPAGO_DRIVER_SUBSCRIPTION_AMOUNT=150
MERCADOPAGO_DRIVER_SUBSCRIPTION_DAYS=7
